...
public class TestPerson {
	...
	public static void main(String[] args) {
		...
		/*create an array to hold 30 person*/
		Person[] classroom = new Person[30];
		
		/*ask how many student are present*/
		/*ask detail and create */
		...
		for(int i=0; i<5; i++) {
			...
			System.out.println("Enter detail for person" + (i+1) + ":");
			...
			classroom[i] = new Person(inputNid, inputFirstName, inputLastName, 
					inputDoB, inputGender, inputHeight, inputWeight);
			
		}
		
	    for (int i = 0; i<5; i++) {
	    	System.out.println("BMI of Person" + (i+1) + ":");
	    	classroom[i].calculateBMI();
	    }
